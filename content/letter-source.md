# A Letter to Our Limited Partners

**Aperture Quantum Partners · Fund II · 14 June 2026 · Maya Chen, Managing Partner**

> Draft v1 (Stage 4 — verified-source revision, 2026-06-09). Word count: ~1,014 body.
> Writer-lead: edit the voice in your shared Google Doc. This file mirrors what is live in `index.html`; the Doc remains the place to argue about sentences.
> Every claim below survived the second verification pass (see `sources-for-review.md`, Addendum). Footnote numbers `[N]` match `app.js` FOOTNOTES.
...
First, on the wind-down. The recommendation, the legal mechanics, and the redeployment vehicle will reach you Monday. We need a quorum response by 30 June.

Second, on the personal carry concession. I am offering to forfeit the entirety of my carry on Fund II and to take a thirty percent reduction in already-paid management fees, refundable to LPs through a structured note over thirty-six months. My partners are offering proportionate terms.
...
**Maya Chen**
Managing Partner, Aperture Quantum Partners

---

## Footnote anchors (verified 2026-06-09, second pass — see sources-for-review.md Addendum)

- **[1]** IBM Condor, 1,121 qubits — IBM Newsroom, 4 Dec 2023. Verbatim: "IBM Condor, a 1,121 superconducting qubit quantum processor based on cross-resonance gate technology." Largest *gate-based superconducting* processor announced as of June 2026 (Atom Computing's 1,180 neutral-atom system is the cross-modality record).
- **[2]** PsiQuantum million-qubit premise — BusinessWire, 10 Sep 2025 ($1B raise). Quote verified verbatim (unspaced em dash).
- **[3]** Google Willow — *Nature* 638, 920–926 (2025; online 9 Dec 2024). 101-qubit distance-7 logical qubit; "1,457 physical qubits" projection verified verbatim.
- **[4]** Bravyi et al. — *Nature* 627, 778–782 (2024). **Simulation result, not hardware** — phrasing must say "shows via circuit-level simulations."
- **[5]** IBM 2022 roadmap — Newsroom, 10 May 2022. 4,000+ qubit 2025 goal, verified verbatim.
- **[6]** IBM Starling / Blue Jay — Newsroom, 10 Jun 2025. 200 logical by 2029; 2,000 logical / 1B ops by 2033. Verified verbatim.
- **[7]** IonQ Form 10-K FY2024 (filed 26 Feb 2025): revenue $43.1M. Concentration via 2024 10-Qs: two customers = 69% (Q1) / 75% (H1) / 79% (9M). AFRL $54.5M award, 25 Sep 2024. FY2025 revenue >$100M — acknowledged in prose ("top line is growing fast").
- **[8]** Preskill, "Beyond NISQ: The Megaquop Machine" — ACM TQC 6(3), Art. 18 (29 Apr 2025); Q2B keynote 11 Dec 2024. Quote verified verbatim.
- **[9]** GRI Quantum Threat Timeline — 2024 edition (32 experts): CRQC within 10 years 19–34%; 2025 edition (26 experts): 28–49%. Quote ranges, not single medians; both editions cited.
- **[10]** Quantum sensing — Cerca OPM-MEG (commercial), CSIRO LANDTEM (commercial, mineral exploration), Q-CTRL Ironstone Opal (defense **trials**, incl. 144-hr Royal Australian Navy sea trial 2025). Navigation must be described as trials, not production.
- **[11]** PQC migration — NIST FIPS 203/204/205 finalized 13 Aug 2024; draft NIST IR 8547 (RSA/ECC deprecated after 2030, disallowed after 2035 — call it draft); NSA CNSA 2.0 (compliant acquisitions from 2027, exclusive use by 2033).

## Maya Chen — Bio (for voice reference)

- 38 years old; lives between New York and London
- PhD condensed-matter physics, Stanford 2014; thesis on superconducting qubits under noise
- IB analyst, 2014–2017 (Morgan Stanley TMT)
- Joined a deep-tech VC firm in 2017 as principal; led their quantum and photonics deals
- Spun out to found Aperture Quantum Partners in 2022, raised $312M Fund II
- Voice: measured, technically literate, dry. Does not punch the air. Owns mistakes by stating them; does not apologize twice.
- Tone references for the writer: Howard Marks (Oaktree memos), Marc Andreessen (early essays), Mary Meeker (Internet Trends decks). Read one Marks memo before editing.

## Writer notes for the next pass

1. The IonQ paragraph now concedes the revenue ramp on purpose — it pre-empts the obvious LP rebuttal ("IonQ just did $100M+"). Don't un-concede it.
2. The GRI sentence deliberately says "rising each edition" — same logic: Maya gets ahead of the acceleration story instead of being ambushed by it.
3. Pillar 1 still ends on "Not the 2020s." — keep the punch.
4. If trimming is ever needed: the two pull quotes on the page repeat body sentences and are display-only; the body is ~1,014 words.
