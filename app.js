...
const ANNOTATIONS = {
  ibm: {
    body: 'IBM\'s published hardware demonstrations of error-corrected logical qubits remain at the single-logical-qubit level. The November 2025 Loon chip validated <em>components</em> of the fault-tolerant architecture; the first logical-memory chip (Kookaburra, 12 logical qubits) is roadmapped for 2026. Starling\'s 200 logical qubits sit two orders of magnitude beyond anything IBM has operated. The 2022 roadmap framed the practical era as beginning with 4,000 physical qubits in 2025.',
    citation: 'IBM Newsroom: 10 June 2025 (Starling); 12 November 2025 (Loon); 10 May 2022 (4,000-qubit goal).',
  },
  ionq: {
    body: 'IonQ has, in fact, delivered ahead of its own roadmap: #AQ 35 in January 2024, a year early; #AQ 64 in September 2025, three months early. Its revenue is ramping too. But "algorithmic qubits" is a benchmark IonQ defined for itself, and the sentence on the left has survived every annual filing since the 2021 listing. The metric moves. The admission stays.',
...
const FOOTNOTES = {
  ...
  '7': '<strong>IonQ, Inc.</strong>, Annual Report on Form 10-K, FY ended 31 December 2024 (filed 26 February 2025): FY2024 revenue $43.1M (vs. $22.0M in 2023). Customer concentration per IonQ\'s 2024 Forms 10-Q: two customers accounted for 69% (Q1), 75% (H1), and 79% (nine months) of total revenue. The $54.5M Air Force Research Lab award (25 September 2024) was the largest U.S. quantum contract of 2024. IonQ\'s FY2025 revenue surpassed $100M; the mix remains led by hardware, networking, and government R&amp;D. <a href="https://www.sec.gov/Archives/edgar/data/1824920/000095017025027722/ionq-20241231.htm" target="_blank" rel="noopener">SEC EDGAR</a> · <a href="https://www.ionq.com/news/ionq-announces-largest-2024-u-s-quantum-contract-award-of-usd54-5m-with" target="_blank" rel="noopener">ionq.com</a>.',
